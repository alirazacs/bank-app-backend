...
namespace BankAppBackend.Repositories
{
    public class ApplicantRepository : IApplicantRepository
    {
        ...
        {
            return _databaseContext.Applicants.Include(applicant => applicant.Customer)
                .Include(applicant => applicant.Teller)
                .FirstOrDefault(applicant => applicant.EmailAddress.Equals(emailAddress));
        }
        ...
        public Applicant? findApplicantById(long applicantId)
        {
            return _databaseContext.Applicants.Include(applicant => applicant.Customer)
                 .Include(applicant => applicant.Teller)
                 .FirstOrDefault(applicant => applicant.Id.Equals(applicantId));
        }
